 ...
 *   },
 *   links = {
 *     "canonical" = "/seo_station_model_url/{seo_station_model_url}",
 *     "add-page" = "/seo_station_model_url/add",
 *     "add-form" = "/seo_station_model_url/add/{seo_station_model_url_type}",
 *     "edit-form" = "/seo_station_model_url/{seo_station_model_url}/edit",
 *     "delete-form" = "/seo_station_model_url/{seo_station_model_url}/delete",
 *     "collection" = "/seo_station_model_url",
 *   },
