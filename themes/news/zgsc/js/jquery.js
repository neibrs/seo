...
$.extend($.validator.messages, {
  ...
  maxlength: $.format("è¯·è¾“å…¥ä¸€ä¸ªé•¿åº¦æœ€å¤šæ˜¯ {0} çš„å­—ç¬¦ä¸²"),
  minlength: $.format("è¯·è¾“å…¥ä¸€ä¸ªé•¿åº¦æœ€å°‘æ˜¯ {0} çš„å­—ç¬¦ä¸²"),
  rangelength: $.format("è¯·è¾“å…¥ä¸€ä¸ªé•¿åº¦ä»‹äºŽ {0} å’Œ {1} ä¹‹é—´çš„å­—ç¬¦ä¸²"),
  range: $.format("è¯·è¾“å…¥ä¸€ä¸ªä»‹äºŽ {0} å’Œ {1} ä¹‹é—´çš„å€¼"),
  max: $.format("è¯¥é¡¹ä¸èƒ½å¤§äºŽ {0}"),
  min: $.format("è¯¥é¡¹ä¸èƒ½å°äºŽ {0}")
});
...
}, "è¯·åªè¾“å…¥å­—æ¯ï¼Œæ•°å­—ï¼Œæ±‰å­—å’Œ'_'ï¼Œ'-'ï¼Œ'@'");
